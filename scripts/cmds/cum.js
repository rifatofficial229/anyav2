...
module.exports = {
  config: {
    ...
    role: 2,
    shortDescription: {
      vi: "Hiển thị hình ảnh ngẫu nhiên",
      en: "Show random cum images"
    },
    longDescription: {
      vi: "Hiển thị một số hình ảnh từ một nguồn đã cho",
      en: "Show  cum images"
    },
    category: "18+",
    guide: {
      vi: "/cum - Hiển thị hình ảnh ngẫu nhiên",
  ...
  langs: {
    vi: {
      noImages: "Không có hình ảnh để hiển thị.",
      imagesSent: "Đã gửi hình ảnh!"
    },
    en: {
